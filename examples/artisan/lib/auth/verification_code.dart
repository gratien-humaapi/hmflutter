    ...
    return AuthLayout(
      header: Column(
        children: [
          ...
          // 5.py,
          Text(
            "Nous avons envoyé le code OTP à votre adresse e-mail.",
            textAlign: TextAlign.center,
            style: TextStyle(
            ...
            TextSpan(
              ...
              recognizer: TapGestureRecognizer()
                ..onTap = () async {
                  try {
                    final bool res =
                        await authService.resendForgotPasswordCode();
                    if (res) {
      ...
      submitButton: SubmitButton(
        ...
        onPress: () {
          ...
          handleSubmit(
            (data) async {
              try {
                final path = await authService.confirmForgotPassword(data);
                print(path);
          ...
          //  NewPasswordRoute().pushReplacement(context);
        },
      ),
    );
  }
