...
class MoreInfo extends HookWidget {
  ...
  Widget build(BuildContext context) {
    ...
    final checkBox1 = useState(false);
    final checkBox2 = useState(false);
      ...
      fieldsMeta: [
        ...
        FieldMeta<SelectProps>(
          ...
          customProps: SelectProps(
            ...
            selectList: ['Français', 'Fon', 'English', 'Español', 'Deutsch'],
            onChange: (String val) {
              // print(val);
            },
    ...
    final form = useForm(
        fieldGroups: [contact, address, userType, category, moreInfos],
        ...
        inputFields: Column(
          children: [
            HMCheckBox(
              ...
              label:
                  "Je suis un particulier et je souhaite proposer mes services.",
              onChange: (value) {
                checkBox1.value = value;
                if (checkBox1.value) {
                  form.form.control("userType").value =
                      UserTypeEnum.contractor.value;
                } else {
                  form.form.control("userType").value = "";
                }
              },
            ...
            HMCheckBox(
              ...
              label: "Je veux payer des services.",
              onChange: (value) {
